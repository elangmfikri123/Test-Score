                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card mt-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5><i class="feather icon-edit"></i> Category Question</h5>
                                    </div>
                                    <hr class="m-0">
                                <div class="card-body">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $category['correct'] }}</td>
                                                    <td class="text-center">{{ $category['incorrect'] }}</td>
                                                    <td class="text-center">{{ $category['skipped'] }}</td>
                                                ...
                                                <tr class="table-primary">
                                                    ...
                                                    <td class="text-center"><strong>{{ $jumlahBenar }}</strong></td>
                                                    <td class="text-center"><strong>{{ $jumlahSalah }}</strong></td>
                                                    <td class="text-center"><strong>{{ $jumlahSkip }}</strong></td>
                                                    <td class="text-center"><strong>{{ $resultDetails ? count($resultDetails) : 0 }}</strong></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
