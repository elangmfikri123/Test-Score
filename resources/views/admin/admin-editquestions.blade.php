                        ...
                        <div class="row">
                            ...
                            <div class="card shadow-sm border-0">
                                ...
                                <div class="card">
                                    ...
                                    <hr class="m-0">
                                    <form action="{{ url('/admin/exams/question-update/' . $question->id) }}" method="POST"
                                        id="questionForm">
                                        @csrf
                                        <div class="card-block">
                                                    ...
                                                    <select name="categoryquestion_id" class="form-control">
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}"
                                                                {{ $question->categoryquestion_id == $category->id ? 'selected' : '' }}>
                                            ...
                                            <table class="table table-bordered" id="soalTable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div id="soal-editor" style="height: 250px;">
                                                                {!! $question->pertanyaan !!}</div>
                                            ...
                                            <table class="table table-bordered" id="jawabanTable">
                                                ...
                                                <tbody>
                                                    @foreach ($question->answers as $i => $answer)
                                                        <tr
                                                            @if ($answer->is_correct) style="background-color: #D4EDDA" @endif>
                                                            <th>Pilihan {{ chr(65 + $i) }}</th>
                                                            <td>
                                                                <input type="hidden" name="answer_ids[]"
                                                                    value="{{ $answer->id }}">
                                                                <div class="jawaban-editor"
                                                                    id="jawaban-editor-{{ $i }}"
                                                                    style="height: 150px;">{!! $answer->jawaban !!}</div>
                                                                <input type="hidden" name="jawaban[]"
                                                                    id="jawaban-content-{{ $i }}">
                                                                @if ($i >= 4)
                                                                    <button type="button"
                                                                        class="btn btn-danger btn-sm removeAnswer mt-2">
