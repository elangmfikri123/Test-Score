                                ...
                                <div class="col-md-9">
                                    <div class="card">
                                        ...
                                        <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                                            <h5>Soal Nomor. {{ $questionNumber }}</h5>
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            {{-- Tombol Sebelumnya --}}
                                            @if ($questionNumber > 1)
                                                <a href="{{ route('exam.start', ['id' => $id, 'questionNumber' => $questionNumber - 1]) }}"
                                                    class="btn btn-secondary">
                                                    <i class="ion-chevron-left"></i> Sebelumnya
                                                </a>
                                            @else
                                                <div></div> {{-- placeholder agar layout tetap rata kiri-kanan --}}
                                            @endif
                                            ...
                                            @if ($questionNumber < $totalQuestions)
                                                <a href="{{ route('exam.start', ['id' => $id, 'questionNumber' => $questionNumber + 1]) }}"
                                                    ...
                                                    Selanjutnya <i class="ion-chevron-right"></i>
                                                </a>
                                            @else
                                                <div></div> {{-- placeholder agar tetap sejajar jika Selanjutnya tidak tampil --}}
                                            @endif
                                        </div>
